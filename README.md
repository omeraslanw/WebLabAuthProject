...
Bu proje, SKY LAB: Bilgisayar Bilimleri Kulübü'ne giriş görevini tamamlamak amacıyla yapılmıştır.
...
1.  **Projeyi Klonlayın veya İndirin:**
    ```sh
    git clone https://github.com/omeraslanw/WebLabAuthProject.git
    ```
...
3.  **SQL Bağlantısını Kod İçinde Yapılandırın:**
    ...
    2.  Aşağıdaki satırda bulunan bağlantı dizesini (`connection string`) kendi SQL Server bilgilerinize göre güncelleyin:
        ...
        public SqlConnection connection()
        {
            ...
            SqlConnection conn = new SqlConnection(@"Data Source=SUNUCU_ADINIZ;Initial Catalog=WebLabAuthDb;Integrated Security=True");
            conn.Open();
            return conn;
        }
        ```
